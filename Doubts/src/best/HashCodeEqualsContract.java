...
/*
 The basic rule of the contract states that if two objects are equal to each other based on equals() 
 method, then the hash code must be the same, but if the hash code is the same, then equals() can return false.
 This means if we override equals then we sud definitley override hashcode but reverse is not true 
 */
package best;
