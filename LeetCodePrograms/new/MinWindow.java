...
public class MinWindow {
	...
	public static void main(String[] args) {
		...
		System.out.println(minWindow1("0123210", "23"));
	} 
	...
	public static String minWindow1(String S, String T) {
        ...
        for (int i = 0; i < lenT; i++) {//"0123210", "23"
            char c = T.charAt(i);
        ...
        for (int right = 0; right < lenS; right++) {//"0123210", "23"
            ...
            //compress the left side.//left =-1
            if (cnt == size) {
                while (left < lenS - 1) {//"0123210", "23"
                    left++;
