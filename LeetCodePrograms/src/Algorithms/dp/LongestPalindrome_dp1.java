...
public class LongestPalindrome_dp1 {
    ...
    // solution 2: ä¸­å¿ƒå±•å¼€æ³• ç©ºé—´å¤�æ�‚åº¦O(1)
    ...
    public static String expandAround(String s, int c1, int c2) { //cabaabad
        int len = s.length();
        ...
        // å¨‰ã„¦å‰°é”›å±¾ç‰´éŽ¹ï¿½substringé�¨å‹«ç•¾æ¶”å¤›ç´�c2æ¶“å¶ˆîœ…é�‘ï¿½
